...
class blog_Post(scrapy.Spider):
    name = 'facebook'
    start_urls = ['https://medium.com/search/posts?q=top&page=1']
    ...
    def parse(self, response):
        for post in response.css('div.l'):
            try:
                ...
                yield {
                    'text':  post.css('div.ec div.l div.ma div.l div.l div.mb div.l div div.l p::text').get()

...
class blog_Post(scrapy.Spider):
    name = 'rentpadData'
    start_urls = ['https://rentpad.com.ph/long-term-rentals/makati/apartment']
    ...
    def parse(self, response):
        for post in response.css('id.view-tile-float-wrap'):
            try:
                ...
                yield {
                    'blog': post.css('div.listing-holder a::attr(herf)').get(),
                    # 'image_url': image_url,

...
class blog_Post(scrapy.Spider):
    name = 'daraz'
    start_urls = ['https://www.daraz.pk/motors-car-care/?spm=a2a0e.home.cate_12_1.6.664e4937BkvEIJ']
    ...
    def parse(self, response):
        for post in response.css('div.c2prKC'):
            try:
